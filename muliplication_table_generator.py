...
radio=tk.IntVar()
radiostorage=Radiobutton(gui,text='10',variable=radio,value=10)
radiostorage.grid(row=2,column=5)
radiostorage1=Radiobutton(gui,text='20',variable=radio,value=20)
radiostorage1.grid(row=4,column=5)
radiostorage2=Radiobutton(gui,text='30',variable=radio,value=30)
radiostorage2.grid(row=6,column=5)
gui.mainloop()